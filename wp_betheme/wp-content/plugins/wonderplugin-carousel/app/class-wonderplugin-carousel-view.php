...
class WonderPlugin_Carousel_View {
	...
	function print_edit_settings() {
		...
		<tr>
			...
			<td><label><input name='jetpackdisablelazyload' type='checkbox' id='jetpackdisablelazyload' <?php echo ($jetpackdisablelazyload == 1) ? 'checked' : ''; ?> /> Disable Jetpack lazy load for carousel thumbnail images</label>
			</td>
		</tr>
	...
	?>
		...
		<ul class="wonderplugin-tabs-horizontal" id="wonderplugin-popup-display-panels">
        	...
        	<p><label><input type="radio" name="keepid" value=0>Append to the existing carousel list </label></p>
